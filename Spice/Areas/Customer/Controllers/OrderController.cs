...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(ApplicationDbContext db, IEmailSender _emailSender)
        {
            _db = db;
        ...
        public async Task<IActionResult> OrderHistory(int productPage = 1)
        {
            ...
            orderListVM.PaginInfo = new PaginInfo
            {
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Ready for Pickup " + orderHeader.Id.ToString(), "Order is ready for pickup.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Cancelled " + orderHeader.Id.ToString(), "Order has been cancelled successfully.");
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully.");
